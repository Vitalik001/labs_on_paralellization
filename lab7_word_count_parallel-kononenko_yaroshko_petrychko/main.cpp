...
int main(int argc, char *argv[]) {
    ...
    auto config_file = command_line_options.get_path_to_file();
    ...
    auto merging_threads_number = options["merging_threads"].as<int>();
    ...
    merging_threads.reserve(merging_threads_number);
    ...
    for (int i = 0; i < merging_threads_number; ++i) {
        merging_threads.emplace_back(&DiskReader::merge_dictionaries, &disk_reader);
    }
